  ...
  config = {
    ...
    home.file.".config/niri/config.kdl".text = ''
      ...
      ${lib.concatStringsSep "\n" (lib.mapAttrsToList (name: mon: ''
       ...
       // Auto-generate VRR window rules if any monitor has VRR
       ${lib.optionalString (lib.any (m: m.vrr) (lib.attrValues systemCfg.monitors)) ''
         window-rule {
